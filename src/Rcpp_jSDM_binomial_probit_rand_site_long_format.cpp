...
// [[Rcpp::export]]
Rcpp::List Rcpp_jSDM_binomial_probit_rand_site_long_format(
...
} // end Rcpp_jSDM_binomial_probit_rand_site_long_format
...
# ngibbs <- nsamp+nburn
# T1 <- Sys.time()
# mod <- Rcpp_jSDM_binomial_probit_rand_site_long_format(
