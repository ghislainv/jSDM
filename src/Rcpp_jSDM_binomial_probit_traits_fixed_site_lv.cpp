...
// [[Rcpp::export]]
Rcpp::List Rcpp_jSDM_binomial_probit_traits_fixed_site_lv(const int ngibbs,const int nthin,const int nburn, 
                                                          const arma::umat &Y, 
                                                          const arma::mat &X,
                                                          const arma::mat &Tr,
...
} // end Rcpp_jSDM_binomial_probit_traits_fixed_site_lv
