...
// [[Rcpp::export]]
Rcpp::List  Rcpp_jSDM_binomial_logit_traits_rand_site_lv(
...
}// end Rcpp_jSDM_binomial_logit_traits_rand_site_lv function
...
# logit.theta <- X %*% beta.target + W %*% t(lambda.target) + alpha.target
