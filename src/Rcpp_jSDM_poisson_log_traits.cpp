...
// [[Rcpp::export]]
Rcpp::List  Rcpp_jSDM_poisson_log_traits(
...
}// end Rcpp_jSDM_poisson_log_traits  function
...
# nt <- ncol(Tr)
# gamma.target <- matrix(runif(nt*np,-0.2,0.2), byrow=TRUE, nrow=nt)
...
# 
# # Call to C++ function
# mod <- Rcpp_jSDM_poisson_log_traits(
...
#   V_gamma=matrix(10,nt,np), V_beta=rep(10,np),
