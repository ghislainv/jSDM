...
// [[Rcpp::export]]
Rcpp::List  Rcpp_jSDM_poisson_log_traits_fixed_site_lv(
...
}// end Rcpp_jSDM_poisson_log_traits_fixed_site_lv function
...
# nt <- ncol(Tr)
# gamma.target <- matrix(runif(nt*np,-0.1,0.1), byrow=TRUE, nrow=nt)
