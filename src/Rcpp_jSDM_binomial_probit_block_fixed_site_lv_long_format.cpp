...
} // end Rcpp_jSDM_binomial_probit_block_fixed_site_lv_long_format
...
#      cbind(summary(MCMC.vl1)[[1]][,"Mean"],summary(MCMC.vl2)[[1]][,"Mean"])%*%t(mean_lambda),
#      xlab="obs", ylab="fitted",main="W.lambda")
# abline(a=0,b=1,col='red')
# ## Deviance
# mean(mod$Deviance)
*/
