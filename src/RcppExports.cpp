...
Rcpp::List Rcpp_jSDM_binomial_logit_lv(const int ngibbs, int nthin, int nburn, arma::umat Y, arma::uvec T, arma::mat X, arma::mat W_start, arma::mat lambda_start, arma::mat beta_start, arma::vec mu_beta, arma::vec V_beta, arma::vec mu_lambda, arma::vec V_lambda, arma::vec V_W, const int seed, const double ropt, const int verbose);
