...
// [[Rcpp::export]]
Rcpp::List Rcpp_jSDM_binomial_probit_traits_rand_site_lv_long_format(
...
} // end Rcpp_jSDM_binomial_probit_traits_rand_site_lv_long_format
...
# # Result analysis
# # ===================================================
# pdf(file="~/Documents/jSDM.test/results_binomial_probit_traits_rand_site_lv_long_format.pdf")
# # Parameter estimates
# par(mfrow=c(1,2))
# hist(probit_theta)
# ## theta
