...
#' @name jSDM_binomial_probit_block_rand_site
#' @aliases jSDM_binomial_probit_block_rand_site
#' @title Binomial probit regression with random site effect 
#' @description The \code{jSDM_binomial_probit_block_rand_site} function performs a Binomial probit regression in a Bayesian framework. The function calls a Gibbs sampler written in C++ code which uses conjugate priors to estimate the conditional posterior distribution of model's parameters.
...
jSDM_binomial_probit_block_rand_site <- function (burnin=5000, mcmc=15000, thin=10,
