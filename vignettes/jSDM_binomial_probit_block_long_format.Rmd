---
title: "Bernoulli probit regression with species traits"
output:
...
vignette: >
 ...
 %\VignetteIndexEntry{Bernoulli probit regression with species traits}
...
$$ \mathrm{probit}(\theta_{n}) =\alpha_i + D_n.\gamma + X_n.\gamma_{sp.j} +  W_i.\lambda_j,$$
...
- $\gamma$ correspond regression coefficients of explanatory variables found in matrix $D=(D_n)_{i=1,\ldots,nobs}$. We use a prior distribution $\mathcal{N}(0,10)$ for all parameters $\gamma$. 
...
## gamma of the first two species
plot(mod$mcmc.gamma)
