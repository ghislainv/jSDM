...
This data-set is available in the \link{\code{jSDM-package}}. It can be loaded with the \link{\code{utils::data} command. The `birds` data-set is in "wide" format: each line is a site and the occurrence data are in columns.
