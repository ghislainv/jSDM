...
```{r current-environmental-data, echo=FALSE, out.width=800, eval=FALSE}
...
```{r fit-JSDM-Mada-table, echo=FALSE, include=TRUE, eval=FALSE}
...
```{r plot-associations, echo=TRUE, eval=FALSE, fig.dim=c(6,6)}
# Forest inventory 
load("~/Documents/projet_BioSceneMada/Report/data/PA.RData")
# Species parameters 
params_species <- read.csv(file = "~/Documents/projet_BioSceneMada/Report/data/params_species.csv")
