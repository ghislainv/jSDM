...
ape::Moran.I(params_sites$alphas, weight=alpha.dists.inv, scaled=TRUE)
...
diag(W1.dists.inv) <- 0
# Using package ape (add in jSDM's Suggests ) 
ape::Moran.I(params_sites$W1, weight=W1.dists.inv, scaled=TRUE)
# Using package terra (no p-value returned)
terra::autocor(params_sites$W1, w=W1.dists.inv,
               method="moran")
...
diag(W2.dists.inv) <- 0
 # Using package ape (add in jSDM's Suggests ) 
ape::Moran.I(params_sites$W2, weight=W2.dists.inv, scaled=TRUE)
# Using pacakge terra (no p-value returned)
terra::autocor(params_sites$W2, w=W2.dists.inv,
               method="moran")
