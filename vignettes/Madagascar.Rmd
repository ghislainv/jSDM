...
Moreover, we can see that the observed species richness is greater in the moist forest of the north-east of the island, particularly on the Masoala peninsula. 
...
```{r plot-associations2, echo=FALSE, out.width=500, out.height=550, eval=TRUE}
...
```{r plot-associations3,  echo=FALSE, out.width=500, out.height=550, eval=TRUE}
...
We represent the occurrence probabilities of two species interpolated at the Madagascar scale. 
...
We can see that the species richness, computed from interpolated occurrence probabilities, is greater in the moist forest of the north-east of the island, particularly on the Masoala peninsula as expected given the observed species richness on inventory sites.  
It can be explained by the fact its the area the most humid and the closer to equator of the island, that benefits a long vegetative season due to high level of light ressources and high water availability [@Vieilledent2013].
...
We can see that the estimated diversity  $\beta$ agrees with the Madagascar's forest types described in the article @Vieilledent2018.  
Indeed the communities of species represented by shades of blue and green seems to correspond to the eastern moist forest and to mangroves, the ones represented by shades of red match pretty well with the western dry forest and the species communities in magenta color could represent the southern spiny forest.
Moreover the $\beta$-diversity map allows to identify more complex and more precise species communities assemblage than the five types of forest represented on the other map.  
In addition, the $\beta$-diversity map allows the identification of a more complex and precise assemblage of species communities than the five forest types represented on the other map. 
