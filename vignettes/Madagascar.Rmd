...
\begin{table}[H]
\caption{Climate data downloaded by the function \texttt{get\_chelsa\_current} and \texttt{get\_chelsa\_future}.}
\begin{tabular}{l|l|l}
\rowcolor{gray!50}
\textbf{Variable} & \textbf{Unit} & \textbf{Source}
Minimum monthly temperatures & $ \celsius \times 10 $ & \href{https://chelsa-climate.org/}{chelsa-climate.org} \\ 
Maximum monthly temperatures & $ \celsius \times $10 & \href{https://chelsa-climate.org/}{chelsa-climate.org} \\ 
Average monthly temperatures & $ \celsius \times $10 & \href{https://chelsa-climate.org/}{chelsa-climate.org} \\
Monthly precipitation & $kg.m^{-2}.month^-1$ & \href{https://chelsa-climate.org/}{chelsa-climate.org} \\
Cloud cover & \% & \href{https://chelsa-climate.org/}{chelsa-climate.org} \\ 
Climatic water deficit (Thornthwaite) & $kg.m^{-2}$ & calculated from data from
& & \href{https://chelsa-climate.org/}{chelsa-climate.org} \\
Potential evapotranspiration (Thornthwaite) & $kg.m^{-2}.month^-1$ & calculated from data from 
& &\href{https://chelsa-climate.org/}{chelsa-climate.org} \\
Number of dry months (Thornthwaite) & months & calculated from data in 
& & \href{https://chelsa-climate.org/}{chelsa-climate.org} \\
Climatic water deficit (Penman-Monteith) & $kg.m^{-2}$ & \href{https://chelsa-climate.org/}{chelsa-climate.org} \\
Potential evapotranspiration (Penman-Monteith) & $kg.m^{-2}.month^-1$ & \href{https://chelsa-climate.org/}{chelsa-climate.org} \\
Number of dry months (Penman-Monteith) & months & calculated from data from 
& &\href{https://chelsa-climate.org/}{chelsa-climate.org} \\
Average annual temperature & $\celsius \times 10$ & \href{https://chelsa-climate.org/}{chelsa-climate.org} \\
Annual mean temperature (bio1) & $\celsius \times 10$ & \href{https://chelsa-climate.org/}{chelsa-climate.org} \\
Diurnal temperature range (bio2) & $\celsius \times 10$ & \href{https://chelsa-climate.org/}{chelsa-climate.org} \\
Isothermality (bio3=bio2/bio7) & $\celsius \times 10$ & \href{https://chelsa-climate.org/}{chelsa-climate.org} \\
Seasonality of temperatures (bio4) & $\celsius / 10$ & \href{https://chelsa-climate.org/}{chelsa-climate.org} \\
Maximum temperature of the warmest month (bio5) & $\celsius \times 10$ & \href{https://chelsa-climate.org/}{chelsa-climate.org} \\
Minimum temperature of the coldest month (bio6) & $\celsius \times 10$ & \href{https://chelsa-climate.org/}{chelsa-climate.org} \\
Annual temperature range (bio7=bio5-bio6) & $\celsius \times 10$ & \href{https://chelsa-climate.org/}{chelsa-climate.org} \\
Average temperature of the wettest quarter (bio8) & $\celsius \times 10$ & \href{https://chelsa-climate.org/}{chelsa-climate.org} \\
Average temperature of the driest quarter (bio9) & $\celsius \times 10$ & \href{https://chelsa-climate.org/}{chelsa-climate.org} \\
Average temperature of the warmest quarter (bio10) & $\celsius \times 10$ & \href{https://chelsa-climate.org/}{chelsa-climate.org} \\
Average temperature of the coldest quarter (bio11) & $\celsius \times 10$ & \href{https://chelsa-climate.org/}{chelsa-climate.org} \\
Cumulative annual precipitation (bio12) & $kg.m^{-2}.year^{-1}$ & \href{https://chelsa-climate.org/}{chelsa-climate.org} \\
Cumulative precipitation of wettest month (bio13) & $kg.m^{-2}.month^{-1}$ & \href{https://chelsa-climate.org/}{chelsa-climate.org} \\
Cumulative precipitation of the driest month (bio14) & $kg.m^{-2}.month^{-1}$ & \href{https://chelsa-climate.org/}{chelsa-climate.org} \\
Seasonality of rainfall (bio15) & $kg.m^{-2}$ & \href{https://chelsa-climate.org/}{chelsa-climate.org} \\
Precipitation in wettest quarter (bio16) & $kg.m^{-2}.month^{-1}$ & \href{https://chelsa-climate.org/}{chelsa-climate.org} \\
Precipitation of driest quarter (bio17) & $kg.m^{-2}.month^{-1}$ & \href{https://chelsa-climate.org/}{chelsa-climate.org} \\
Warmest quarter precipitation (bio18) & $kg.m^{-2}.month^{-1}$ & \href{https://chelsa-climate.org/}{chelsa-climate.org} \\
Coldest quarter precipitation (bio19) & $kg.m^{-2}.month^{-1}$ & \href{https://chelsa-climate.org/}{chelsa-climate.org} \\
\end{tabular}
\end{table}
...
write.csv(params_species,
          file ="~/Documents/projet_BioSceneMada/Report/Internship_Report/data/params_species.csv",
          row.names = F)

## probit_theta_latent
write.csv(mod_all$probit_theta_latent,
          file = "~/Documents/projet_BioSceneMada/Report/Internship_Report/data/probit_theta_latent.csv",
          row.names = F)
## theta_latent
...
terra::plot(Mada_borders, col="lightgray",
            ...
            cex.main=1.4)
terra::plot(theta_latent_sp, y="Ocotea.laevis", pch=20, cex=1.1,
...
id_pres_Manilkara <- which(PA[,"Manilkara hexandra"]==1)
...
terra::plot(theta$Ocotea.laevis,
            main=names(theta)[1])
terra::points(obs_pres_Ocotea, pch=3, cex=0.7)
terra::plot(theta$Manilkara.hexandra,
            main=names(theta)[6])
