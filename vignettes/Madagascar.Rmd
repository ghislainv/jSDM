...
MADA <- readRDS("~/Documents/projet_BioSceneMada/Report/Internship_Report/data/MADA.rds")
...
clim <- stack("~/Documents/projet_BioSceneMada/Report/Internship_Report/data/current.tif")
...
scaled_clim_var <- stack("~/Documents/projet_BioSceneMada/Report/Internship_Report/data/scaled_clim.tif")
...
for (n in 1:npart){
  ...
  writeRaster(probit_theta,
              file=paste0("~/Documents/projet_BioSceneMada/Report/Internship_Report/data/RST_probit_theta_", n, ".tif"),
              format="GTiff", options=c("COMPRESS=LZW", "PREDICTOR=2"), overwrite=TRUE)
  ...
  writeRaster(theta, 
              file=paste0("~/Documents/projet_BioSceneMada/Report/Internship_Report/data/RST_theta_",n,".tif"),
              format="GTiff", options=c("COMPRESS=LZW", "PREDICTOR=2"), overwrite=TRUE)
  remove(theta)
}
```
...
npart <- 10
first.species <- seq(1,nsp,by=floor(nsp/npart)+1)
theta <- stack("~/Documents/projet_BioSceneMada/Report/Internship_Report/data/RST_theta_1.tif")
...
npart <- 10
for(n in 2:npart){
theta <- stack(paste0("~/Documents/projet_BioSceneMada/Report/Internship_Report/data/RST_theta_", n, ".tif"))
species_richness <- species_richness + sum(theta)
}
writeRaster(species_richness,
            file=paste0("~/Documents/projet_BioSceneMada/Report/Internship_Report/data/species_richness.tif"), 
            format="GTiff", options=c("COMPRESS=LZW", "PREDICTOR=2"), overwrite=TRUE)
```
...
forest <- stack("~/Documents/projet_BioSceneMada/Report/Internship_Report/data/for2000.tif")
...
species_richness <- stack("~/Documents/projet_BioSceneMada/Report/Internship_Report/data/species_richness_30m.tif")
species_richness_deforest <- mask(species_richness,forest)
writeRaster(species_richness_deforest,file="~/Documents/projet_BioSceneMada/Report/Internship_Report/data/species_richness_deforest.tif",
                format="GTiff", options=c("COMPRESS=LZW", "PREDICTOR=2"), overwrite=TRUE)
```
...
species_richness <- raster("~/Documents/projet_BioSceneMada/Report/Internship_Report/data/species_richness_30m.tif")
species_richness_deforest <- raster("~/Documents/projet_BioSceneMada/Report/Internship_Report/data/species_richness_deforest.tif")
par(oma=c(0,0,1,1))
...
for(k in 1:nrow(theta)){
  cat(k, "/", nrow(theta),"\n")
  theta <- raster::stack("~/Documents/projet_BioSceneMada/Report/Internship_Report/data/RST_theta_1.tif")
  ...
  theta_k <- foreach(n=1:npart, .combine = "cbind") %dopar%{
    theta <- raster::stack(paste0("~/Documents/projet_BioSceneMada/Report/Internship_Report/data/RST_theta_",
                                  n, ".tif"))
...
writeRaster(coords,file="~/Documents/projet_BioSceneMada/Report/Internship_Report/data/coords.tif",
                format="GTiff", options=c("COMPRESS=LZW", "PREDICTOR=2"), overwrite=TRUE)
...
# Coloration RGB
writeRaster(coords_RGB,file=paste0("~/Documents/projet_BioSceneMada/Report/Internship_Report/data/species_turnover.tif"),
                format="GTiff", options=c("COMPRESS=LZW", "PREDICTOR=2"), overwrite=TRUE)
```
