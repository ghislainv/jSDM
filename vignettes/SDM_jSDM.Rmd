...
save(beta_est_bayescomm, T_BayesComm, file="~/Documents/jSDM/vignettes/SDM_jSDM_files/BayesComm.rda")
```
...
save(beta_est_bayescomm_lv, Z_BayesComm, T_BayesComm_lv, file="~/Documents/jSDM/vignettes/SDM_jSDM_files/BayesComm_lv.rda")
```
...
```{r plot2-BayesComm_lv, echo=FALSE}
