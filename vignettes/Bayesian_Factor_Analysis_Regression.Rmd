...
# diag(mat) <- c(3,4) bad results with correction
diag(mat) <- runif(n_latent,2,3)
...
Rcpp::sourceCpp("/home/clement/Documents/jSDM/src/Rcpp_jSDM_binomial_probit_lv_corr.cpp")
# Starting parameters 
beta_start <- c(-2,-1,1,2)
