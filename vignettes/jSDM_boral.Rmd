...
We start by simulating the dataset that we will then analyze among other real datasets.  
...
We plot the parameters estimated with `jSDM` against those fitted with `boral`.
...
knitr::include_graphics("jSDM_boral_files/figure-html/jSDM-boral-simulation-4.png")
```
...
knitr::include_graphics("jSDM_boral_files/figure-html/jSDM-boral-mosquitos-4.png")
```
...
knitr::include_graphics("jSDM_boral_files/figure-html/jSDM-boral-Eucalypts-4.png")
```
...
knitr::include_graphics("jSDM_boral_files/figure-html/jSDM-boral-frogs-4.png")
```
...
knitr::include_graphics("jSDM_boral_files/figure-html/jSDM-boral-fungi-4.png")
```
...
knitr::include_graphics("jSDM_boral_files/figure-html/jSDM-boral-birds-4.png")
```
...
knitr::include_graphics("jSDM_boral_files/figure-html/jSDM-boral-mites-4.png")
```
