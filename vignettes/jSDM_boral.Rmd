...
library(jagsUI)
T1 <- Sys.time()
# Number of trials by site impossible to specify with boral, trial.size either equal to a single element, or a vector of length equal to the number of columns in y
...
Computed for or the probabilities of presences $\theta_{ij}$ with the simulated data-set.
