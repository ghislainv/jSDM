...
# Fit the model
T1<-Sys.time() 
mod_jSDM_block_sim <-  jSDM_binomial_probit_block_rand_site_lv (
  presence_site_sp=Y, 
  site_suitability=~.,   
...
# Fit the model
T1 <- Sys.time()
mod_jSDM_block_Mosquito <- jSDM_binomial_probit_block_rand_site_lv (
...
# Fit the model
T1 <- Sys.time()
mod_jSDM_block_Eucalypts <- jSDM_binomial_probit_block_rand_site_lv (
...
# Fit the model 
T1 <- Sys.time()
mod_jSDM_block_Frogs <- jSDM_binomial_probit_block_rand_site_lv (
...
# Fit the model
T1 <- Sys.time()
mod_jSDM_block_Fungi <- jSDM_binomial_probit_block_rand_site_lv (
