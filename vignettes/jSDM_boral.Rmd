...
+ mod_boral_sim$lv.coefs.mean[,"beta0"] 
...
plot(t(beta.target),
     ...
     xlab="beta target", ylab="means of estimated beta") 
abline(a=0,b=1,col='red')
## factor loadings lambda_j
plot(t(lambda.target),mod_boral_sim$lv.coefs.mean[,-1],
     xlab="lambda target", ylab="means of estimated lambda") 
abline(a=0,b=1,col='red')
## Latent variable W 
par(mfrow=c(1,2))
for (l in 1:nl) {
...
```{r boral-simulation-plot2, echo=FALSE, eval=TRUE, out.width=800}
knitr::include_graphics("jSDM_boral_figures/boral-simulation-plot-1.png")
knitr::include_graphics("jSDM_boral_figures/boral-simulation-plot-2.png")
knitr::include_graphics("jSDM_boral_figures/boral-simulation-plot-3.png")
knitr::include_graphics("jSDM_boral_figures/boral-simulation-plot-4.png")
```
...
+ mod_boral_Mosquitos$lv.coefs.mean[,"beta0"]
+ mod_boral_Mosquitos$lv.mean%*% 
  t(mod_boral_Mosquitos$lv.coefs.mean[,-1])
...
+ mod_boral_Eucalypts$lv.coefs.mean[,"beta0"]
+ mod_boral_Eucalypts$lv.mean%*%
  t(mod_boral_Eucalypts$lv.coefs.mean[,-1])
...
+ mod_boral_Frogs$lv.coefs.mean[,"beta0"]
...
# Predicted probit(theta) 
probit_theta_pred_Birds <- mod_boral_Birds$row.coefs[[1]]$mean
+ as.matrix(X_Birds) %*% t(mod_boral_Birds$X.coefs.mean)
+ mod_boral_Birds$lv.coefs.mean[,"beta0"]
+ mod_boral_Birds$lv.mean%*%t(mod_boral_Birds$lv.coefs.mean[,-1])

# Deviance
logL=0
for (i in 1:nrow(PA_Birds)){
  for (j in 1:ncol(PA_Birds)){
    theta <- min(pnorm(probit_theta_pred_Birds[i,j])
                 ,0.9999999999999999)
...
# Predicted probit(theta) 
log_theta_pred_Mites <- mod_boral_Mites$row.coefs[[1]]$mean
+ as.matrix(X_Mites[,-1]) %*% t(mod_boral_Mites$X.coefs.mean)
+ mod_boral_Mites$lv.coefs.mean[,"beta0"]
...
```{r jSDM-simulation-plot2, echo=FALSE, eval=TRUE, out.width=800}
knitr::include_graphics("jSDM_boral_figures/jSDM-simulation-plot-1.png")
knitr::include_graphics("jSDM_boral_figures/jSDM-simulation-plot-2.png")
knitr::include_graphics("jSDM_boral_figures/jSDM-simulation-plot-3.png")
knitr::include_graphics("jSDM_boral_figures/jSDM-simulation-plot-4.png")
knitr::include_graphics("jSDM_boral_figures/jSDM-simulation-plot-5.png")
knitr::include_graphics("jSDM_boral_figures/jSDM-simulation-plot-6.png")
knitr::include_graphics("jSDM_boral_figures/jSDM-simulation-plot-7.png")
knitr::include_graphics("jSDM_boral_figures/jSDM-simulation-plot-8.png")
knitr::include_graphics("jSDM_boral_figures/jSDM-simulation-plot-9.png")
knitr::include_graphics("jSDM_boral_figures/jSDM-simulation-plot-10.png")
...
save(T_jSDM_sim, Deviance_jSDM_sim, RMSE_jSDM_sim, RMSE_boral_sim, T_boral_sim, Deviance_boral_sim, T_jSDM_Mosquitos, Deviance_jSDM_Mosquitos ,T_jSDM_Eucalypts, Deviance_jSDM_Eucalypts, T_jSDM_Frogs, Deviance_jSDM_Frogs,T_jSDM_Fungi, Deviance_jSDM_Fungi, T_jSDM_Birds, Deviance_jSDM_Birds, T_jSDM_Mites, Deviance_jSDM_Mites, T_boral_Mosquitos, Deviance_boral_Mosquitos, T_boral_Eucalypts, Deviance_boral_Eucalypts, T_boral_Frogs, Deviance_boral_Frogs, T_boral_Fungi, Deviance_boral_Fungi, T_boral_Birds, Deviance_boral_Birds, T_boral_Mites, Deviance_boral_Mites,
     file="jSDM_boral_figures/jSDM-boral-comparison.rda")
```

## Compilation time and deviance 

```{r time-deviance, echo=FALSE, eval=TRUE, out.width=900}
load("jSDM_boral_figures/jSDM-boral-comparison.rda")
...
knitr::include_graphics("jSDM_boral_figures/jSDM-boral-simulation-1.png")
knitr::include_graphics("jSDM_boral_figures/jSDM-boral-simulation-2.png")
knitr::include_graphics("jSDM_boral_figures/jSDM-boral-simulation-3.png")
```
...
knitr::include_graphics("jSDM_boral_figures/jSDM-boral-mosquitos-1.png")
knitr::include_graphics("jSDM_boral_figures/jSDM-boral-mosquitos-2.png")
knitr::include_graphics("jSDM_boral_figures/jSDM-boral-mosquitos-3.png")
```
...
knitr::include_graphics("jSDM_boral_figures/jSDM-boral-Eucalypts-1.png")
knitr::include_graphics("jSDM_boral_figures/jSDM-boral-Eucalypts-2.png")
knitr::include_graphics("jSDM_boral_figures/jSDM-boral-Eucalypts-3.png")
```
...
```{r jSDM-boral-frogs-plot, echo=FALSE, eval=TRUE, out.width=800}
knitr::include_graphics("jSDM_boral_figures/jSDM-boral-frogs-1.png")
knitr::include_graphics("jSDM_boral_figures/jSDM-boral-frogs-2.png")
knitr::include_graphics("jSDM_boral_figures/jSDM-boral-frogs-3.png")
```
...
```{r jSDM-boral-fungi-plot, echo=FALSE, eval=TRUE, out.width=800}
knitr::include_graphics("jSDM_boral_figures/jSDM-boral-fungi-1.png")
knitr::include_graphics("jSDM_boral_figures/jSDM-boral-fungi-2.png")
knitr::include_graphics("jSDM_boral_figures/jSDM-boral-fungi-3.png")
```
...
```{r jSDM-boral-birds-plot, echo=FALSE, eval=TRUE, out.width=800}
knitr::include_graphics("jSDM_boral_figures/jSDM-boral-birds-1.png")
knitr::include_graphics("jSDM_boral_figures/jSDM-boral-birds-2.png")
knitr::include_graphics("jSDM_boral_figures/jSDM-boral-birds-3.png")
```
...
```{r jSDM-boral-mites-plot, echo=FALSE, eval=TRUE, out.width=800}
knitr::include_graphics("jSDM_boral_figures/jSDM-boral-mites-1.png")
knitr::include_graphics("jSDM_boral_figures/jSDM-boral-mites-2.png")
knitr::include_graphics("jSDM_boral_figures/jSDM-boral-mites-3.png")
```
