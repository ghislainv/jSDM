...
load(file="~/Documents/jSDM/vignettes/jSDM_boral_cache/boral_simulation.RData")
...
save(np, nl, nsp, nsite, beta.target, lambda.target, alpha.target, 
     ...
     file="~/Documents/jSDM/vignettes/jSDM_boral_cache/boral_simulation.RData")
```

```{r boral-simulation-plot,eval=FALSE}
load(file="~/Documents/jSDM/vignettes/jSDM_boral_cache/boral_simulation.RData")
...
![](jSDM_boral_files/figure-html/boral-simulation-plot-1.png)
![](jSDM_boral_files/figure-html/boral-simulation-plot-2.png)
![](jSDM_boral_files/figure-html/boral-simulation-plot-3.png)
![](jSDM_boral_files/figure-html/boral-simulation-plot-4.png)
...
save(T_boral_Mosquitos, mod_boral_Mosquitos,
     ...
     file="~/Documents/jSDM/vignettes/jSDM_boral_cache/boral_Mosquitos.RData")
```
...
save(T_boral_Eucalypts, mod_boral_Eucalypts,
     ...
     file="~/Documents/jSDM/vignettes/jSDM_boral_cache/boral_Eucalypts.RData")
```
...
save(T_boral_Frogs, mod_boral_Frogs,
     ...
     file="~/Documents/jSDM/vignettes/jSDM_boral_cache/boral_Frogs.RData")
```
...
save(T_boral_Fungi, mod_boral_Fungi,
     ...
     file="~/Documents/jSDM/vignettes/jSDM_boral_cache/boral_Fungi.RData")
```
...
save(T_boral_Birds, mod_boral_Birds,
     ...
     file="~/Documents/jSDM/vignettes/jSDM_boral_cache/boral_Birds.RData")
```
...
save(T_jSDM_sim, mod_jSDM_sim, RMSE_jSDM_sim,
     file="~/Documents/jSDM/vignettes/jSDM_boral_cache/jSDM_simulation.RData")
```

```{r jSDM-simulation-plot}
load(file="~/Documents/jSDM/vignettes/jSDM_boral_cache/jSDM_simulation.RData")
load(file="~/Documents/jSDM/vignettes/jSDM_boral_cache/boral_simulation.RData")
# ===================================================
# Result analysis
# ===================================================
...
## Deviance
plot(Deviance_jSDM_sim, main="Deviance")
...
![](jSDM_boral_files/figure-html/jSDM-simulation-plot-1.png)
![](jSDM_boral_files/figure-html/jSDM-simulation-plot-2.png)
![](jSDM_boral_files/figure-html/jSDM-simulation-plot-3.png)
![](jSDM_boral_files/figure-html/jSDM-simulation-plot-4.png)
![](jSDM_boral_files/figure-html/jSDM-simulation-plot-5.png)
![](jSDM_boral_files/figure-html/jSDM-simulation-plot-6.png)
![](jSDM_boral_files/figure-html/jSDM-simulation-plot-7.png)
![](jSDM_boral_files/figure-html/jSDM-simulation-plot-8.png)
![](jSDM_boral_files/figure-html/jSDM-simulation-plot-9.png)
![](jSDM_boral_files/figure-html/jSDM-simulation-plot-10.png)
## Mosquitos dataset
...
save(T_jSDM_Mosquitos, mod_jSDM_Mosquitos,
     file="~/Documents/jSDM/vignettes/jSDM_boral_cache/jSDM_Mosquitos.RData")
```
...
save(T_jSDM_Eucalypts, mod_jSDM_Eucalypts,
     file="~/Documents/jSDM/vignettes/jSDM_boral_cache/jSDM_Eucalypts.RData")
```
...
save(T_jSDM_Frogs, mod_jSDM_Frogs,
     file="~/Documents/jSDM/vignettes/jSDM_boral_cache/jSDM_Frogs.RData")
```
...
save(T_jSDM_Fungi, mod_jSDM_Fungi,
     file="~/Documents/jSDM/vignettes/jSDM_boral_cache/jSDM_Fungi.RData")
```
...
save(T_jSDM_Birds, mod_jSDM_Birds,
     file="~/Documents/jSDM/vignettes/jSDM_boral_cache/jSDM_Birds.RData")
```
...
save(T_jSDM_Mites, mod_jSDM_Mites,
     file="~/Documents/jSDM/vignettes/jSDM_boral_cache/jSDM_Mites.RData")
```
...
load(file="~/Documents/jSDM/vignettes/jSDM_boral_cache/jSDM_simulation.RData")
# Mosquitos dataset
load(file="~/Documents/jSDM/vignettes/jSDM_boral_cache/boral_Mosquitos.RData")
load(file="~/Documents/jSDM/vignettes/jSDM_boral_cache/jSDM_Mosquitos.RData")
# Eucalypts dataset
load(file="~/Documents/jSDM/vignettes/jSDM_boral_cache/boral_Eucalypts.RData")
load(file="~/Documents/jSDM/vignettes/jSDM_boral_cache/jSDM_Eucalypts.RData")
# Frogs dataset 
load(file="~/Documents/jSDM/vignettes/jSDM_boral_cache/boral_Frogs.RData")
load(file="~/Documents/jSDM/vignettes/jSDM_boral_cache/jSDM_Frogs.RData")
# Fungi dataset 
load(file="~/Documents/jSDM/vignettes/jSDM_boral_cache/boral_Fungi.RData")
load(file="~/Documents/jSDM/vignettes/jSDM_boral_cache/jSDM_Fungi.RData")
# Birds dataset
load(file="~/Documents/jSDM/vignettes/jSDM_boral_cache/boral_Birds.RData")
load(file="~/Documents/jSDM/vignettes/jSDM_boral_cache/jSDM_Birds.RData")
# Mites dataset
load(file="~/Documents/jSDM/vignettes/jSDM_boral_cache/boral_Mites.RData")
load(file="~/Documents/jSDM/vignettes/jSDM_boral_cache/jSDM_Mites.RData")
...
file="~/Documents/jSDM/vignettes/jSDM_boral_files/figure-html/jSDM-boral-comparison.rda")
```

## Compilation time and deviance 

```{r time, eval=TRUE, echo=FALSE}
load(file="~/Documents/jSDM/vignettes/jSDM_boral_files/figure-html/jSDM-boral-comparison.rda")
...
![](jSDM_boral_files/figure-html/jSDM-boral-simulation-1.png)
![](jSDM_boral_files/figure-html/jSDM-boral-simulation-2.png)

![](jSDM_boral_files/figure-html/jSDM-boral-simulation-3.png)
### Mosquitos dataset
...
![](jSDM_boral_files/figure-html/jSDM-boral-mosquitos-1.png)
![](jSDM_boral_files/figure-html/jSDM-boral-mosquitos-2.png)

![](jSDM_boral_files/figure-html/jSDM-boral-mosquitos-3.png)
...
![](jSDM_boral_files/figure-html/jSDM-boral-Eucalypts-1.png)
![](jSDM_boral_files/figure-html/jSDM-boral-Eucalypts-2.png)

![](jSDM_boral_files/figure-html/jSDM-boral-Eucalypts-3.png)
...
![](jSDM_boral_files/figure-html/jSDM-boral-frogs-1.png)
![](jSDM_boral_files/figure-html/jSDM-boral-frogs-2.png)

![](jSDM_boral_files/figure-html/jSDM-boral-frogs-3.png)
...
![](jSDM_boral_files/figure-html/jSDM-boral-fungi-1.png)
![](jSDM_boral_files/figure-html/jSDM-boral-fungi-2.png)
![](jSDM_boral_files/figure-html/jSDM-boral-fungi-3.png)
...
![](jSDM_boral_files/figure-html/jSDM-boral-birds-1.png)
![](jSDM_boral_files/figure-html/jSDM-boral-birds-2.png)

![](jSDM_boral_files/figure-html/jSDM-boral-birds-3.png)
...
![](jSDM_boral_files/figure-html/jSDM-boral-mites-1.png)
![](jSDM_boral_files/figure-html/jSDM-boral-mites-2.png)

![](jSDM_boral_files/figure-html/jSDM-boral-mites-3.png)
