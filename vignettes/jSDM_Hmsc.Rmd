...
theta_pred_sim <- apply(computePredictedValues(mod_Hmsc_sim),c(1,2),mean)
probit_theta_pred_sim <- qnorm(theta_pred_sim)
# RMSE
...
for (i in 1:nsite){
  for (j in 1:nsp){
    logL=logL + dbinom(Y[i,j],1,theta_pred_sim[i,j],1)  
  }
}
Deviance_Hmsc_sim <- -2*logL

save(np, nl, nsp, nsite, beta.target, lambda.target, X, W, probit_theta, Z_true, Y, T_Hmsc_sim,
     mod_Hmsc_sim, probit_theta_pred_sim,
...
# Predicted probit(theta) 
theta_pred_Mosquitos  <- apply(computePredictedValues(mod_Hmsc_Mosquitos),c(1,2),mean)
probit_theta_pred_Mosquitos  <- qnorm(theta_pred_Mosquitos)

# Deviance 
logL=0
for (i in 1:nrow(PA_Mosquitos)){
  for (j in 1:ncol(PA_Mosquitos)){
    logL=logL + dbinom(PA_Mosquitos [i,j],1,theta_pred_Mosquitos[i,j],1)  
  }
}
Deviance_Hmsc_Mosquitos  <- -2*logL

save(T_Hmsc_Mosquitos, mod_Hmsc_Mosquitos,
     probit_theta_pred_Mosquitos, Deviance_Hmsc_Mosquitos,
...
# Predicted probit(theta) 
theta_pred_Eucalypts  <- apply(computePredictedValues(mod_Hmsc_Eucalypts),c(1,2),mean)
probit_theta_pred_Eucalypts  <- qnorm(theta_pred_Eucalypts)

# Deviance 
logL=0
for (i in 1:nrow(PA_Eucalypts)){
  for (j in 1:ncol(PA_Eucalypts)){
    logL=logL + dbinom(PA_Eucalypts[i,j],1,theta_pred_Eucalypts[i,j],1)  
  }
}
Deviance_Hmsc_Eucalypts  <- -2*logL

save(T_Hmsc_Eucalypts, mod_Hmsc_Eucalypts,
     probit_theta_pred_Eucalypts, Deviance_Hmsc_Eucalypts,
...
# Predicted probit(theta) 
theta_pred_Frogs  <- apply(computePredictedValues(mod_Hmsc_Frogs),c(1,2),mean)
probit_theta_pred_Frogs  <- qnorm(theta_pred_Frogs)

# Deviance 
logL=0
for (i in 1:nrow(PA_Frogs)){
  for (j in 1:ncol(PA_Frogs)){
    logL=logL + dbinom(PA_Frogs [i,j],1,theta_pred_Frogs[i,j],1)  
  }
}
Deviance_Hmsc_Frogs  <- -2*logL

save(T_Hmsc_Frogs, mod_Hmsc_Frogs,
     probit_theta_pred_Frogs, Deviance_Hmsc_Frogs,
...
# Predicted probit(theta) 
theta_pred_Fungi  <- apply(computePredictedValues(mod_Hmsc_Fungi),c(1,2),mean)
probit_theta_pred_Fungi  <- qnorm(theta_pred_Fungi)

# Deviance 
logL=0
for (i in 1:nrow(PA_Fungi)){
  for (j in 1:ncol(PA_Fungi)){
    logL=logL + dbinom(PA_Fungi[i,j],1,theta_pred_Fungi[i,j],1)  
  }
}
Deviance_Hmsc_Fungi  <- -2*logL

save(T_Hmsc_Fungi, mod_Hmsc_Fungi,
     probit_theta_pred_Fungi, Deviance_Hmsc_Fungi,
...
# Predicted probit(theta) 
theta_pred_Birds  <- apply(computePredictedValues(mod_Hmsc_Birds),c(1,2),mean)
probit_theta_pred_Birds  <- qnorm(theta_pred_Birds)

# Deviance
logL=0
for (i in 1:nrow(PA_Birds)){
  for (j in 1:ncol(PA_Birds)){
    logL= logL + dbinom(PA_Birds[i,j],1,theta_pred_Birds[i,j],1)  
  }
}
Deviance_Hmsc_Birds <- -2*logL
save(T_Hmsc_Birds, mod_Hmsc_Birds,
     probit_theta_pred_Birds, Deviance_Hmsc_Birds,
...
# Predicted probit(theta) 
theta_pred_Mites  <- apply(computePredictedValues(mod_Hmsc_Mites),c(1,2),mean)
log_theta_pred_Mites  <- log(theta_pred_Mites)

# Deviance
logL=0
for (i in 1:nrow(PA_Mites)){
  for (j in 1:ncol(PA_Mites)){
    logL=logL + dpois(PA_Mites[i,j],theta_pred_Mites[i,j],1)  
  }
}
Deviance_Hmsc_Mites <- -2*logL

save(T_Hmsc_Mites, mod_Hmsc_Mites,
     log_theta_pred_Mites, Deviance_Hmsc_Mites,
...
We fit a binomial joint species distribution model, including latent variables, from the simulated dataset using the `jSDM_binomial_probit_block()` function to perform binomial probit regression.
...
We fit a binomial joint species distribution model, including latent variables, from the [`mosquitos`](https://ecology.ghislainv.fr/jSDM/reference/mosquitos.html) dataset using `jSDM_binomial_probit_block()` function to perform binomial probit regression.
...
We fit a binomial joint species distribution model, including latent variables, from the [`eucalypts`](https://ecology.ghislainv.fr/jSDM/reference/eucalypts.html) dataset using `jSDM_binomial_probit_block()` function to perform binomial probit regression.
...
We fit a binomial joint species distribution model, including latent variables, from the [`frogs`](https://ecology.ghislainv.fr/jSDM/reference/frogs.html) dataset using `jSDM_binomial_probit_block()` function to perform binomial probit regression.
...
We fit a binomial joint species distribution model, including latent variables, from the [`fungi`](https://ecology.ghislainv.fr/jSDM/reference/fungi.html) dataset using `jSDM_binomial_probit_block()` function to perform binomial probit regression.
...
We fit a binomial joint species distribution model including latent variables, from the [`birds`](https://ecology.ghislainv.fr/jSDM/reference/birds.html) dataset using `jSDM_binomial_probit_block()` function to perform binomial probit regression.
...
# Fit the model
T1 <- Sys.time()
mod_jSDM_Birds <- jSDM_binomial_probit_block(
    # Chains 
  burnin=10000, mcmc=5000, thin=5,
  # Response variable 
...
```{r load-fitted-models, echo=FALSE, include=FALSE, eval=TRUE}
# Simulated dataset
load(file="jSDM_Hmsc_cache/Hmsc_simulation.RData")
load(file="jSDM_Hmsc_cache/jSDM_simulation.RData")
# Mosquitos dataset
...
# Predictions 
par(mfrow=c(1,1))
plot(probit_theta_pred_sim, mod_jSDM_sim$probit_theta_pred, xlab="fitted by Hmsc", ylab="fitted by jSDM", main="Predicted probit(theta)")
abline(a=0,b=1,col='red')
```
...
# Predictions 
par(mfrow=c(1,1))
plot(probit_theta_pred_Mosquitos, mod_jSDM_Mosquitos$probit_theta_pred, xlab="fitted by Hmsc", ylab="fitted by jSDM", main="Predicted probit(theta)")
abline(a=0,b=1,col='red')
```
...
# Predictions 
par(mfrow=c(1,1))
plot(probit_theta_pred_Eucalypts, mod_jSDM_Eucalypts$probit_theta_pred, xlab="fitted by Hmsc", ylab="fitted by jSDM", main="Predicted probit(theta)")
abline(a=0,b=1,col='red')
```
...
# Predictions 
par(mfrow=c(1,1))
plot(probit_theta_pred_Frogs, mod_jSDM_Frogs$probit_theta_pred, xlab="fitted by Hmsc", ylab="fitted by jSDM", main="Predicted probit(theta)")
abline(a=0,b=1,col='red')
```
...
# Predictions 
par(mfrow=c(1,1))
plot(probit_theta_pred_Fungi, mod_jSDM_Fungi$probit_theta_pred, xlab="fitted by Hmsc", ylab="fitted by jSDM", main="Predicted probit(theta)")
abline(a=0,b=1,col='red')
```
...
# Predictions 
par(mfrow=c(1,1))
plot(c(probit_theta_pred_Birds), mod_jSDM_Birds$probit_theta_pred, xlab="fitted by Hmsc", ylab="fitted by jSDM", main="probit(theta)")
abline(a=0,b=1,col='red')
```
...
# Predictions 
par(mfrow=c(1,1))
plot(log_theta_pred_Mites, apply(mod_jSDM_Mites$theta_latent,c(1,2),log), xlab="fitted by Hmsc", ylab="fitted by jSDM", main="log(theta)")
abline(a=0,b=1,col='red')
```
