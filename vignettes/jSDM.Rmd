...
```{r jSDM, cache=TRUE}
T1<- Sys.time()
mod_jSDM_block_frogs <- jSDM_binomial_probit_block_rand_site_lv(# Chains
...
## V_alpha
par(mfrow=c(1,2))
coda::traceplot(mod_jSDM_block_frogs$mcmc.V_alpha, main="V_alpha")
coda::densplot(mod_jSDM_block_frogs$mcmc.V_alpha, main="V_alpha")
...
# Predictions 
theta_pred <- predict(mod_jSDM_block_frogs, newdata=simdata, Id_species=Id_species,
