...
(ref:cap-frog) **Frog Litoria ewingii**. @Wilkinson2019.
...
# Predictions 
theta_pred <- predict.jSDM(mod_jSDM_block_frogs, newdata =simdata, Id_species =Id_species, Id_sites = Id_sites, type="mean")
